...
If you're injecting the `SerializerInterface` directly, there is nothing to do. The normalizer from `digital-craftsman/self-aware-normalizers` are registered automatically and will handle the serialization and deserialization of the id as it implements the `StringNormalizable` interface.
...
If you're injecting the `SerializerInterface` directly, there is nothing to do. The normalizer from `digital-craftsman/self-aware-normalizers` are registered automatically and will handle the serialization and deserialization of the id as it implements the `ArrayNormalizable` interface.
